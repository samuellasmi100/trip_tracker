...
const TENANT_TABLE_SCHEMAS = {
  ...
  leads: {
    ...
    columns: [
      ...
      { name: 'followup_date',     definition: 'date DEFAULT NULL' },
      { name: 'last_contact_date', definition: 'date DEFAULT NULL' },
      { name: 'price',             definition: 'decimal(10,2) DEFAULT NULL' },
      { name: 'discount',          definition: 'decimal(10,2) DEFAULT NULL' },
