...
import { useStyles } from "./IncomeForm.style";
  ...
  return (
    <div className={classes.root}>
      <Typography className={classes.title}>
        {isEdit ? "עריכת הכנסה" : "הוספת הכנסה"}
      </Typography>
      ...
      <div style={{ padding: "0 20px", marginBottom: "12px" }}>
        <InputLabel className={classes.inputLabel}>תיאור</InputLabel>
        <TextField
          name="description"
          value={form.description || ""}
          onChange={handleInputChange}
          className={classes.descriptionField}
          placeholder="תיאור ההכנסה (אופציונלי)"
          size="small"
        />
      </div>
